...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		wechatQRRoute := apiRouter.Group("/wechat-qr")
		{
			...
			wechatQRRoute.GET("/request-status", controller.GetWechatQRRequestStatus)
			wechatQRRoute.GET("/task", controller.GetWechatQRTask)
		...
		{
			marketRoute.GET("/activities", middleware.TryUserAuth(), controller.GetMarketActivities)
			marketRoute.GET("/activities/:id", middleware.TryUserAuth(), controller.GetMarketActivity)
			marketRoute.GET("/activities/:id/works", middleware.TryUserAuth(), controller.GetMarketActivityWorks)
			marketRoute.POST("/uploads", middleware.UserAuth(), controller.UploadMarketFile)
			marketRoute.GET("/uploads/:key", middleware.TryUserAuth(), controller.GetMarketUpload)
			marketRoute.POST("/activities/:id/submissions", middleware.UserAuth(), controller.CreateMarketSubmission)
			marketRoute.GET("/submissions/self", middleware.UserAuth(), controller.GetMarketSubmissionsSelf)
			marketAdminRoute := marketRoute.Group("/admin")
			marketAdminRoute.Use(middleware.AdminAuth())
			{
				marketAdminRoute.GET("/activities", controller.AdminGetMarketActivities)
				marketAdminRoute.GET("/activities/:id", controller.AdminGetMarketActivity)
				marketAdminRoute.POST("/activities", controller.AdminCreateMarketActivity)
				marketAdminRoute.PUT("/activities/:id", controller.AdminUpdateMarketActivity)
				marketAdminRoute.PATCH("/activities/:id/status", controller.AdminUpdateMarketActivityStatus)
				marketAdminRoute.DELETE("/activities/:id", controller.AdminDeleteMarketActivity)
				marketAdminRoute.GET("/submissions", controller.AdminGetMarketSubmissions)
				marketAdminRoute.PATCH("/submissions/:id/status", controller.AdminUpdateMarketSubmissionStatus)
				marketAdminRoute.PATCH("/submissions/:id/feature", controller.AdminUpdateMarketSubmissionFeature)
		...
		toolsRoute := apiRouter.Group("/tools")
		{
			...
			toolsRoute.GET("/skills/acquired", middleware.UserAuth(), controller.GetAcquiredSkills)
			toolsRoute.POST("/skills/:skill_id/acquire", middleware.UserAuth(), controller.AcquireSkill)
			toolsRoute.POST("/skills/:skill_id/call-billing", middleware.UserAuth(), controller.BillSkillCall)
			...
			toolsRoute.POST("/:tool_id/actions/:action_id/run", middleware.UserAuth(), controller.RunUserToolAction)
			toolsRoute.PUT("/:tool_id/actions/:action_id/config", middleware.UserAuth(), controller.UpdateToolActionConfig)
			toolsRoute.PUT("/:tool_id/config", middleware.UserAuth(), controller.UpdateToolConfig)
		...
		apiRouter.POST("/auth/sms/login", middleware.CriticalRateLimit(), controller.SMSLogin)
		...
		apiRouter.POST("/wechatpay/webhook", controller.WeChatPayWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/tools", controller.GetUserTools)
				...
				selfRoute.POST("/wechatpay/amount", controller.RequestWeChatPayAmount)
				selfRoute.POST("/wechatpay/pay", middleware.CriticalRateLimit(), controller.RequestWeChatPayPay)
				selfRoute.GET("/wechatpay/status", controller.GetWeChatPayOrderStatus)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/waffo/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestWaffoPay)
		}
