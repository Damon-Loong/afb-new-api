...
type User struct {
	...
	Phone            *string        `json:"phone,omitempty" gorm:"type:varchar(32);index"`
	...
	AffQuota         int            `json:"aff_quota" gorm:"type:int;default:0;column:aff_quota"`           // 待划转奖励额度
	AffHistoryQuota  int            `json:"aff_history_quota" gorm:"type:int;default:0;column:aff_history"` // 历史累计奖励额度
...
func (user *User) Insert(inviterId int) error {
	...
	if inviterId != 0 {
		...
		if common.QuotaForInviter > 0 {
			...
			RecordLog(inviterId, LogTypeSystem, fmt.Sprintf("邀请用户获得奖励 %s", logger.LogQuota(common.QuotaForInviter)))
